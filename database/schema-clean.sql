-- =====================================================
-- CLEAN DATABASE (Run this FIRST if you have existing tables)
-- =====================================================
-- WARNING: This will delete ALL existing data!

-- Drop existing tables in reverse order (to avoid FK constraint errors)
...
-- =====================================================
-- SYNTA ACADEMY - SUPABASE DATABASE SCHEMA
-- =====================================================
...
-- =====================================================
-- 9. USER PROFILES (Extended user info)
-- =====================================================
CREATE TABLE user_profiles (
  id UUID PRIMARY KEY REFERENCES auth.users(id) ON DELETE CASCADE,
  full_name TEXT,
  phone TEXT,
  level TEXT, -- 'bac-1', 'bac-2', 'bac-3', etc.
  specialization TEXT, -- 'info', 'math', 'sciences', etc.
...
BEGIN
  ...
  RAISE NOTICE '1. Go to Authentication → Users to create test users';
  RAISE NOTICE '2. Add your Supabase credentials to backend/.env';
